            ...
            <div className="bg-white fixed z-40 w-full top-0 left-0 border-b border-gray-200 h-46">
                ...
                <nav className="max-w-screen-xl flex items-center justify-between mx-auto p-4 mt-14" >
                    ...
                    <div className="flex md:order-2 gap-2">
                        ...
                        {isAuthUser ? <button className="mt-1.5 inline-block roun bg-black px-5 py-3 text-xs font-medium upprcase tracking-wide text-white">Déconnexion</button> : <button>Connexion</button>}
                        <button
