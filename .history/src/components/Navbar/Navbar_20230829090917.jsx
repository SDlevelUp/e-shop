...
export default function Navbar() {
    return (
        <>
            ...
            <div className="bg-white fixed z-40 w-full top-0 left-0 border-b border-gray-200 h-100">
                ...
                <nav className="max-w-screen-xl flex items-center justify-between mx-auto p-4">
                    <div className="flex items-center cursor-pointer">
                        <span className="self-center text-2xl font-semibold whitespace-nowrap p-8">
                            E-Shop
                        </span>
                    </div>
